...
public class BlockRiceAutoCrafting extends Block implements ITileEntityProvider {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityRiceAutoCrafting craft = (TileEntityRiceAutoCrafting) worldIn.getTileEntity(pos);
        if (craft instanceof TileEntityRiceAutoCrafting) {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityRiceAutoCrafting) craft);
        }
