...
public class SlotAutoCraftingItemHandler extends Slot {
    private final InventoryRiceAutoCrafting craftingInv;
    private final IItemHandler matrix;
    private final EntityPlayer player;

    public SlotAutoCraftingItemHandler(EntityPlayer player, InventoryCrafting craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
        super(inventoryIn, slotIndex, xPosition, yPosition);
        craftingInv = (InventoryRiceAutoCrafting)craftingInventory;
        this.player = player;
        this.matrix = ((InventoryRiceAutoCrafting)craftingInventory).craft.matrix;
    }
